...
export default async function initial_data_seed({
  ...
  logger.info("Seeding store data for Kenya...");
  const {
  ...
  logger.info("Seeding region data for Kenya...");
  ...
  logger.info("Seeding tax regions for Kenya...");
  ...
  if (taxRegions && taxRegions.length > 0) {
    logger.info("Setting Kenya VAT tax rate to 16%...");
  ...
  const fulfillmentSet = await fulfillmentModuleService.createFulfillmentSets({
    name: "Nairobi Warehouse delivery",
    type: "shipping",
    service_zones: [
      {
        name: "Kenya Delivery Zone",
        geo_zones: [
          {
            country_code: "ke",
            type: "country",
  ...
  logger.info("Kenyanized database seeding complete!");
}
